        ...
        <section className="mt-20 px-4 md:px-8">
            ...
            <div className="mt-8 text-center">
                ...
                <div className="flex justify-center">
                    <Link to="/contact" className="cursor-pointer font-medium w-50 md:w-auto px-6 py-3 text-white text-center tracking-wider bg-indigo-600 hover:bg-indigo-700 focus:ring-2 focus:ring-offset-2 focus:ring-indigo-900 rounded-lg mt-6 duration-500 flex items-center justify-center" onClick={scrollToTop}>
